# v3.0.5
## 13 Jul 2022 — 20:13:32 UTC

### chore

+ __build:__ Update Repository URL
 ([0bfba51](https://github.com/coldbox-modules/cors/commit/0bfba5122dabf1a9bcb26f7162a5588383e29afd))
+ __build:__ Add Slack notifications back in
 ([38fbda0](https://github.com/coldbox-modules/cors/commit/38fbda09258b8862e264312900e24a013f497d57))
+ __LICENSE:__ Add link to license inside box.json
 ([f95a9df](https://github.com/coldbox-modules/cors/commit/f95a9df9dcdb1531e026943f900a0c71b306a4e6))

### other

+ __\*:__ feat: Added new module setting to set custom closure to check if preflight response should be returned ([5165046](https://github.com/coldbox-modules/cors/commit/51650468cd22cfc7a78af3355cfd975184458bce))
+ __\*:__ chore: Skip cache test for now
 ([1d496f0](https://github.com/coldbox-modules/cors/commit/1d496f056fa0be4560ae02beda798abd9a9e4d93))
+ __\*:__ chore: Try to fix timeout during test
 ([f4b0e56](https://github.com/coldbox-modules/cors/commit/f4b0e562f30c718b37d09e7b6990f7512fdeaa95))
+ __\*:__ chore: Update port for GitHub Actions
 ([a71b8e8](https://github.com/coldbox-modules/cors/commit/a71b8e86631085e26201a8d70a53fa5832f3c9a1))
+ __\*:__ Add GitHub Actions
 ([6e76c1e](https://github.com/coldbox-modules/cors/commit/6e76c1eaca0bb45702e09ee7d4b6f28705a3504a))
+ __\*:__ chore: Fix tests
 ([645f304](https://github.com/coldbox-modules/cors/commit/645f30484466110847f7503447510115aae232be))
+ __\*:__ 3.0.6 ([899db4f](https://github.com/coldbox-modules/cors/commit/899db4f4edbf6fedddd12ded5034238acba0cd52))
+ __\*:__ 3.0.5 ([1eb4259](https://github.com/coldbox-modules/cors/commit/1eb4259d27a800a6fab9a7475adbcf261517d7d3))
+ __\*:__ fix: Support for Multiple Allowed Origins ([1e10b33](https://github.com/coldbox-modules/cors/commit/1e10b336002b23255b2fcfb85dde4f963f99be58))
